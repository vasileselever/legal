...
public static class DatabaseSeeder
{
    ...
    private static async Task SeedDocumentAutomationAsync(ApplicationDbContext context)
    {
        ...
        var serviciiFields = new List<DocumentTemplateField>
        {
            ...
            new() { Id = Guid.NewGuid(), TemplateId = tplServicii.Id, FieldKey = "include_tva", Label = "TVA inclusa", LabelEn = "VAT included?", FieldType = TemplateFieldType.SingleChoice, SortOrder = 19, Section = "Durat\u0103 & Pre\u021b", IsRequired = true, OptionsJson = "[\"inclusiv TVA\",\"exclusiv TVA\",\"neimpozabil\"]", DefaultValue = "exclusiv TVA", CreatedAt = now },
