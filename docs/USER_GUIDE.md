...
**Problem:** Icons in User Management or other pages display as question marks
...
3. **Restart dev server:**
   ...
   npm run dev
   ```
4. **Verify file encoding:** VS Code bottom-right should show "UTF-8"
...
- **[USER_ICONS_VISUAL_COMPARISON.md](./USER_ICONS_VISUAL_COMPARISON.md)** - What icons should look like
