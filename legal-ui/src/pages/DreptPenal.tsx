export function DreptPenal() {
  const services = [
    ...
    { icon: "\u{1F464}", title: "Infractiuni contra Persoanei", desc: "Reprezentare in dosare de loviri, vatamari corporale, amenintare, santaj si alte infractiuni impotriva persoanei." },
