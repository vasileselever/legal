export function DreptComercial() {
  const services = [
    ...
    { icon: "\u{1F30D}", title: "Drept Comercial International", desc: "Consultanta in contracte internationale, arbitraj comercial international si conformitate cu reglementarile UE." },
  ];
  ...
  return (
    <div style={{maxWidth:"900px",margin:"0 auto",padding:"2rem",fontFamily:"sans-serif"}}>
      <div style={{background:"linear-gradient(135deg,#1565c0,#1976d2)",color:"white",padding:"3rem 2rem",borderRadius:"8px",marginBottom:"2rem",textAlign:"center"}}>
        ...
        <p style={{fontSize:"1.2rem",opacity:0.9,margin:0}}>Consultanta juridica specializata pentru companii, antreprenori si investitori</p>
      </div>
